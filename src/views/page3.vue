<template>
    <Row class="page3">
        <Col style="width:26%;">
            <div class="left">
                <span class='title'><span class="title-text">供能规模及趋势</span></span>
        ...
        <Col style="width:48%;padding:0 1%;">
            ...
            <div class="center-bottom">
                <span class='title'><span class="title-text">能耗组成</span></span>
                <span class="angle1"></span>
                <span class="angle2"></span>
                <span class="angle3"></span>
                <span class="angle4"></span>
        ...
        <Col style="width:26%">
            <div class="right-1">
                <div class="right1-1">
                    <span class='title'><span class="title-text">装机容量及构成</span></span>
                    <span class="angle1"></span>
                    <span class="angle2"></span>
                    <span class="angle3"></span>
                    <span class="angle4"></span>
            ...
            <div class="right-1">
                <div class="right1-1">
                    <span class='title'><span class="title-text">区域能效排名</span></span>
                    <span class="angle1"></span>
                    <span class="angle2"></span>
                    <span class="angle3"></span>
                    <span class="angle4"></span>
            ...
            <div class="right-2">
                <div class="right1-1">
                    <span class='title'><span class="title-text">能源站能效排名</span></span>
                    <span class="angle1"></span>
                    <span class="angle2"></span>
                    <span class="angle3"></span>
                    <span class="angle4"></span>
        ...
        return {
            data1: [
                {
                    ...
                    top: '20%',
                    data: {name: "供冷", value: 45, color: '#0E4CFF'},
                },
                {
                    subtitle: '675人（2345次/4533元）',
                    top: '36%',
                    data: {name: "供热", value: 60, color: '#B405FD'},
                },
                {
                    subtitle: '675人（2345次/4533元）',
                    top: '53%',
                    data: {name: "供热", value: 12, color: '#FE9900'},
                },
                {
                    subtitle: '675人（2345次/4533元）',
                    top: '69%',
                    data: {name: "供冷", value: 24, color: '#FF6600'},
                },
                {
                    subtitle: '675人（2345次/4533元）',
                    top: '85%',
                    data: {name: "供热", value: 21, color: '#7F05FD'}
            ...
            data3: [
                ...
                },
                {
                    subtitle: '675人（2345次/4533元）',
                    top: '54%',
                    data: {name: "供热", value: 60, color: '#FE9900'},
                },
                {
                    subtitle: '675人（2345次/4533元）',
                    top: '78%',
                    data: {name: "供冷", value: 12, color: '#7F05FD'},
                },
            ],
            data2: [ // 网赌用户排名数据
                {
